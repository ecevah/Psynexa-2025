...
const MeditationBlog = () => {
  return (
    <>
      <div className="py-[16px] pr-[24px] pl-[74px] flex flex-row gap-[40px] rounded-[24px] bg-[rgba(0,84,133,0.30)] w-fit absolute bottom-[200px] -right-[380px]">
        ...
        <div className="flex flex-col gap-[7px] w-[271px]">
          <p className="text-[24px] text-white font-bold leading-[32px]">
            Meditation and Audio Blog Listening
          </p>
          <p className="text-[18px] text-white leading-[24px]">
            Immerse yourself in personalized meditation sessions and inspiring
            audio blogs to calm your mind and uplift your spirit.
          </p>
        </div>
      </div>
    </>
