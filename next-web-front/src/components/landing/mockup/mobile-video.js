...
const MobileVideo = () => {
  ...
  return (
    <div className="z-20 my-[80px]">
      <div className="w-[445px] h-[287px] relative overflow-hidden rounded-[32px] max-w-[445px] max-h-[287px] max-[480px]:w-[300px] max-[480px]:h-[180px]">
        {!isPlaying ? (
          <div
