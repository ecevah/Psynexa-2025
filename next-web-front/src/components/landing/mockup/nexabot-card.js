...
const NexabotCard = () => {
  ...
  return (
    <>
      <div
        className="pl-[24px] py-[24px] pr-[150px] rounded-[24px] bg-[rgba(0,84,133,0.30)] backdrop:blur-[100px] flex flex-row absolute top-[100px] -left-[400px] gap-[40px]"
        data-aos="fade-right"
      >
